...
import ru.selenium.training.utils.SingletonWebdriverHolder;
...
public class Task5_browserFirefox {
    private WebDriver driver;
    private WebDriverWait wait;

    public static WebDriver getDriver() {
        return SingletonWebdriverHolder.getDriver();
    }
...
//        driver = new FirefoxDriver();
        SingletonWebdriverHolder.setDriver(new FirefoxDriver());
